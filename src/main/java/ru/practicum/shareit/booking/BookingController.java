...
public class BookingController {
    ...
    public List<BookingDto> findAll(@RequestHeader(USER_HEADER) Long userId,
        ...
        List<BookingDto> bookingDtoList = bookingService.findAll(userId, getValidState(bookingState));
    ...
    public List<BookingDto> getAllOwner(@RequestHeader(USER_HEADER) Long ownerId,
        ...
        List<BookingDto> bookingDtoList = bookingService.findAllOwner(ownerId, getValidState(bookingState));
        log.info("Список всех бронирований текущего владельца получен");
        return bookingDtoList;
    }

    private BookingState getValidState(String bookingState) {
